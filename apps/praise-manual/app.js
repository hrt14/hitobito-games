(()=>{
  ...
  const Q=[
    {scene:'仕事・学校',q:'大きなことをやり切った。いちばん嬉しいのは？',a:'みんなの前で「今回すごかった！」',b:'帰り際に1対1で「本当に良かった」と言われる',A:{privacy:-24,calm:-10,result:-4},B:{privacy:24,calm:12}},
  ...
  function strongest(s){
    return Object.entries(s).map(([k,v])=>({k,v,d:Math.abs(v-50)})).sort((a,b)=>b.d-a.d);
  }
