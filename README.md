...
- `apps/mukaebi` — **向かい火 / MUKAEBI**  風向きの予報を読み、火が来る前に防火線を引き、その内側へ向かい火を放って「火の食料」を先に消す山火事鎮圧ゲーム。水は3発しか無く、強い風では細い防火線は火に飛び越えられる。守るために自分で森を焼く判断を繰り返す。設計と実プレイ記録は [`FUN_REPORT.json`](./apps/mukaebi/FUN_REPORT.json)。
