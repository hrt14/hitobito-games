...
**遊んで、考え方と行動を切り替える無料Webアプリ。**

インストール不要。いま困っていることに近い入口を選び、その場で短く始められます。

- [LEVEL UPを開く](https://levelup.hitobito.jp/)
- [悩みから探す](https://levelup.hitobito.jp/problems/)

## 今の状態から始める

- [先延ばしで動けない](https://levelup.hitobito.jp/problems/ugokenai/) — 最初の一手まで小さくする
- [嫌なこと・失言を引きずる](https://levelup.hitobito.jp/problems/hikizuru/) — 必要な反省だけ残して終える
- [人の目・嫌われるのが気になる](https://levelup.hitobito.jp/problems/hitonome/) — 他人の評価と自分の行動を分ける
- [考えすぎて頭がいっぱい](https://levelup.hitobito.jp/problems/kangaesugi/) — 今考えることだけに絞る
- [スマホをやめたい](https://levelup.hitobito.jp/problems/smartphone/) — 刺激との距離を作る
