...
const AUTO_META = {
  ...
  'approval-off': {
    ...
    skill: '承認欲求 / 自分軸',
    icon: '◎',
    forWho: '何かを選ぶとき「自分はどうしたいか」より「どう思われるか」が先に浮かぶ人',
    purpose: '他人が決める評価と、自分で決められる行動を分け、判断のハンドルを自分側へ戻す',
    benefit: '承認を拒まずに、相手の反応を待たず自分の基準で次の一手を選びやすくする',
  },
  'jinshin-shoaku': {
    title: '人の心の動かし方',
    kicker: 'PEOPLE SKILLS / 6 SCENES',
    skill: '人を動かす会話 / 信頼',
    icon: '◎',
    forWho: '部下が動かない、お願いが伝わらない、関係を悪くせず相手に協力してほしい人',
    purpose: '相手が何を守りたいかを見抜き、命令ではなく「自分から動きたい」と思える返しを選べるようにする',
    benefit: '依頼・指摘・任せ方・商談で、「どう言えば相手が動きやすいか」の会話の引き出しが増える',
  },
  'impulse-cooldown': {
    title: '24時間、寝かせる。',
    kicker: '24H COOLDOWN / MONEY',
    skill: '衝動買い対策 / お金',
    icon: '⏳',
    forWho: 'ネットショッピングでカートに入れた瞬間、指がすぐ購入ボタンに伸びる人',
    purpose: 'なぜ欲しいか・無くても困るか・1週間後も欲しいかを判定し、今すぐ買う・24時間寝かせる・やめるへ自分で仕分ける',
    benefit: '衝動買いの後悔を減らし、浮いたお金を記録として積み上げていく',
  },
  nukeru: {
    title: 'ぬける。',
  ...
  'mada-dekinai': {
    title: 'まだ、できない。',
    kicker: 'NOT YET',
    skill: '成長マインドセット / 学習反射',
    icon: 'YET',
    forWho: '失敗や難題の直後に「向いてない」「才能がない」と能力の判定までしてしまう人',
    purpose: '固定的な反応に気づき、「まだ」から次の学習行動を1つ選ぶ反射を鍛える',
    benefit: '失敗を自己評価で終わらせず、戦略変更・フィードバック・助け・部分練習へ移りやすくする',
  },
  'boundary-map': {
    ...
    skill: '境界線 / 自己認識',
    icon: '境',
    forWho: '頼まれると断れず、後から「なんで引き受けたんだろう」と疲れてしまう人',
    purpose: '20個の頼まれごとへの反応から、時間・お金・感情・価値観のどこで境界線がすり減りやすいかを可視化する',
    benefit: 'すり減りやすい領域と、次に使える一言を持ち帰り、結果をカード画像としてシェアできる',
  },
};
