...
const AUTO_META = {
  ...
  'jinshin-shoaku': {
    title: '人心掌握トレーニング',
    kicker: 'TRUST WITHOUT CONTROL',
    skill: '信頼形成 / 自律性 / 面子',
    icon: '◎',
    forWho: '人を動かしたい場面ほど、正論・指示・説得に寄りすぎて関係を固くしてしまう人',
    purpose: '相手の自己像・理想・選択権・面子を守りながら、協力が生まれる返しを反射化する',
    benefit: '「従わせる」より、相手が自分で決めて動ける関係を作る選択肢が増える',
  },
  nukeru: {
    title: 'ぬける。',
