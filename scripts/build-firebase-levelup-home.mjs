...
// This is intentionally explicit. It mirrors the curated LEVEL UP catalog that
// lived on the Vercel/Next.js portal before the Firebase migration. Do not
// auto-add every app tagged "levelup" here: doing so changes the product.
const catalog = [
  {
    slug: 'start', title: 'START', kicker: 'MBTI TO ACTION', skill: '着手 / 極小化',
    description: 'MBTIを選び、自分に合う始め方で宿題を最初の一手まで小さくして、現実で動き出す。',
    icon: 'GO', href: '/start', updateCount: 1, special: true,
  },
  {
    slug: '3sec-action', title: '3秒で動け', kicker: 'THINK LESS, START SMALL', skill: '即着手',
    description: '3秒以内に「やる・捨てる・任せる」。考え込む前に動く反射を鍛える。',
    icon: '03', updateCount: 1,
  },
  {
    slug: 'ato-5min', title: 'あと5分', kicker: 'BREAK IT DOWN', skill: 'タスク分解',
    description: '巨大な仕事を最初の一手まで小さくし、動けるサイズへ分解する反射を鍛える。',
    icon: '05', updateCount: 3,
  },
  {
    slug: 'one-thing', title: '一個だけやれ', kicker: 'ONE THING UNTIL DONE', skill: '集中 / WIP制御',
    description: '通知や割り込みに触れず、選んだ一個を最後まで終える集中力を鍛える。',
    icon: '01', updateCount: 3,
  },
  {
    slug: 'timecraft', title: '時間を使え。', kicker: "USE TIME, DON'T FILL IT", skill: '時間術 / 優先順位',
    description: '時間の使い方、優先順位、余白の作り方を予定づくりで反復する。',
    icon: '8H', updateCount: 1,
  },
  {
    slug: '100-turns', title: '死ぬまでに、あと100ターン', kicker: 'TIME IS FINITE', skill: '有限性 / 選択',
    description: '残り100ターンの人生で何に時間を使うかを選び、有限な時間を体で覚える。',
    icon: '100', updateCount: 1,
  },
  {
    slug: 'task-separation', title: '課題の分離', kicker: 'WHOSE TASK IS THIS?', skill: '境界線 / 集中',
    description: '「これは誰の課題か？」を切り分け、自分の課題だけに集中する反射を鍛える。',
    icon: '↔', updateCount: 2,
  },
  {
    slug: 'levelup-control', title: '変えられる？', kicker: 'CONTROL WHAT YOU CAN', skill: 'コントロール / 次の一手',
    description: '変えられることと変えられないことを素早く切り分け、次の一手へ進む。',
    icon: '◉', updateCount: 1,
  },
  {
    slug: 'expect-nothing', title: '期待しない', kicker: 'DROP THE SHOULD', skill: '期待を手放す',
    description: '相手や予定への「こうなるはず」を手放し、期待に振り回されない考え方を反復する。',
    icon: '0', updateCount: 1,
  },
  {
    slug: 'dont-change-people', title: '人を変えるな', kicker: 'CHANGE YOUR RESPONSE', skill: '対人調整 / 境界線',
    description: '相手を変えようとせず、自分の距離・頼み方・配置を変えて問題を解く。',
    icon: '人', updateCount: 1,
  },
  {
    slug: 'help-me', title: '助けて', kicker: "DON'T CARRY IT ALONE", skill: '頼る / 委任',
    description: '仕事を一人で抱えず、人・AI・外注・上司へ適切に頼るほど物事が進む。',
    icon: 'HELP', updateCount: 1,
  },
  {
    slug: 'levelup-mood', title: '機嫌は自分で取る', kicker: 'OWN YOUR STATE', skill: '感情調整',
    description: '外部の出来事に任せず、自分で自分の機嫌を整える選択肢を増やしていく。',
    icon: '☺', updateCount: 1,
  },
  {
    slug: 'mou-owatta', title: 'もう終わった', kicker: 'END THE LOOP', skill: '切り替え / 反芻停止',
    description: '終わった出来事を反芻せず、事実と次に変えられることだけ拾って思考を終了する。',
    icon: 'END', updateCount: 1,
  },
  {
    slug: 'name-it', title: '名前をつけろ', kicker: 'NAME THE FEELING', skill: '感情認識',
    description: 'いま感じている感情に名前をつけ、ぼんやり抱えず認識する反射を鍛える。',
    icon: 'Aa', updateCount: 1,
  },
  {
    slug: 'viewpoint-exam', title: '物の見方検定', kicker: 'FIND ANOTHER VIEW', skill: '視点転換',
    description: '嫌な出来事にも別の見方を何通りも作り、視点を切り替える型を反復する。',
    icon: '↻', updateCount: 1,
  },
  {
    slug: 'jinsei-title', title: '人生にタイトルをつけろ', kicker: 'EDIT THE STORY', skill: '意味づけ / 編集',
    description: '同じ出来事でもタイトルを変えると意味が変わる。人生の出来事を編集する力を鍛える。',
    icon: 'T', updateCount: 1,
  },
  {
    slug: 'main-character', title: '主人公で行け。', kicker: 'LIVE YOUR STORY', skill: '自己決定',
    description: '周囲の「普通」ではなく、自分が人生の主人公ならどう動くかを選び続ける。',
    icon: '★', updateCount: 1,
  },
  {
    slug: 'arigatou-sagashi', title: 'ありがとう探し', kicker: 'NOTICE WHAT SUPPORTS YOU', skill: '感謝 / 観察',
    description: '何気ない日常を支えているものを次々に見つけ、感謝を観察ゲームとして鍛える。',
    icon: '＋', updateCount: 1,
  },
  {
    slug: 'levelup-smalltalk', title: '雑談力アップ', kicker: 'KEEP THE TALK MOVING', skill: '雑談 / 会話',
    description: '雑談の返し・広げ方・質問を反復し、自然に会話を続けるパターンを身につける。',
    icon: '…', updateCount: 1,
  },
  {
    slug: 'watashi-zukan', title: 'わたし図鑑', kicker: 'KNOW YOUR CHOICES', skill: '自己理解',
    description: 'ゲーム中の意思決定から、安定と挑戦・一人と仲間・お金と時間など自分の選び方を知る。',
    icon: '私', updateCount: 19,
  },
  {
    slug: 'maa-iika', title: 'まあ、いいか。', kicker: 'ACCEPT, THEN MOVE', skill: '受容 / 切り替え',
    description: '予定外に抵抗し続けず、「そうなったか」と受け取り、次へ進む反射を鍛える。',
    icon: '→', href: '/maa-iika', updateCount: 1, special: true,
  },
  {
    slug: 'self-management', title: '自分を回せ。', kicker: 'SELF MANAGEMENT TRAINING', skill: '自己管理 / WIP制御',
    description: '体力、集中、ストレス、脳内WIPを見て、その瞬間に最適な一手を選ぶ。',
    icon: 'WIP', href: '/self-management', updateCount: 1, special: true,
  },
];

for (const game of catalog) {
  if (!game.special && !available.has(game.slug)) {
    throw new Error(`Curated LEVEL UP game is missing from Firebase bundle: ${game.slug}`);
  }
  if (!game.href) game.href = `/apps/${encodeURIComponent(game.slug)}/`;
}

const games = [...catalog].sort((a, b) => {
  if (b.updateCount !== a.updateCount) return b.updateCount - a.updateCount;
  return catalog.indexOf(a) - catalog.indexOf(b);
});

fs.writeFileSync(
  path.join(outDir, 'levelup-catalog.json'),
  JSON.stringify({ version: 1, games: games.map(({ special, ...game }) => game) }, null, 2) + '\n',
);
...
const cards = games.map((game, index) => `
  <a class="card" href="${escapeHtml(game.href)}" data-game="${escapeHtml(game.slug)}">
    <div class="card-top">
...
<body>
  <main class="shell">
    ...
    <section class="hero">
      <div><div class="hero-kicker">PLAY. REPEAT. CHANGE.</div><h1>LEVEL<br><span>UP.</span></h1></div>
      <div><p class="hero-copy">考え方、行動、切り替え、自己理解。知識を読むだけでなく、ゲームとして何度も判断して、日常で使える思考の癖にする。</p><div class="stats"><div><strong>${games.length}</strong><span>TRAINING GAMES</span></div><div><strong>0</strong><span>API COST</span></div></div></div>
    </section>
...
console.log(`[Firebase] Curated LEVEL UP home generated: ${games.length} games`);
