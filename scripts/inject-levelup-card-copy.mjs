...
const COPY = {
  ...
  'anti-vision-day': {
    forWho: '今の生活や仕事に違和感はあるのに、理想を書くだけでは行動が変わらず、このまま数年続くのは嫌だと感じている人',
    purpose: '避けたい5年後と選びたい5年後を同じ日に具体化し、日中の行動がどちらへ向いているか5回見直す',
    benefit: '漠然とした停滞感を、1年・1か月・明日の順に縮めて、明日やる具体的な一手を1つ決められる',
  },
  'anger-first-aid': {
  ...
  'hard-request': {
    forWho: '必要なお願いがあるのに、相手が嫌がりそうだと黙って抱え込みやすい人',
    purpose: '自分と相手の領域を分け、責めずに具体的なお願いを組み立てる',
    benefit: 'NOや不機嫌を恐れすぎず、必要なことを丁寧に伝え切りやすくなる',
  },
  'hontono-shimekiri': {
  ...
  'miss-check-reflex': {
    forWho: '右左・宛先・日付・コピー元と先など、分かっているのに同じ取り違えを繰り返す人',
    purpose: '思い込みで押す直前に「止まる→対象を見る→声に出す→実行する」の確認順序を反射化する',
    benefit: '実務に戻ったとき、注意力だけに頼らず短い確認動作を挟んで同じ種類のミスを減らしやすくなる',
  },
  'mou-haratta': {
  ...
  'success-side': {
    forWho: '挑戦する前に「失敗したら」を何通りも考え、行動が弱くなりやすい人',
    purpose: '失敗予想を増やすのを止め、必要なリスク確認だけして成功側の一手へ戻る',
    benefit: '考えすぎで勢いを失わず、成功確率を上げる具体的な行動を1つ選びやすくなる',
  },
  'suteru-yuki': {
